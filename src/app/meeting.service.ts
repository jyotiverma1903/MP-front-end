...
export class MeetingService {
  ...
  public baseUrl ='http://api.jyotivermprojects.info/api/v1/meeting';
  ...
  constructor(public http : HttpClient) {
   ...
   public getAllMeetingForUserId(userData): any {
    let myResponse = this.http.post(this.baseUrl + '/getAllMeetingsForUser', userData);
    return myResponse;
  }
  ...
  public getMeetingByMeetingId(data):any{
    let myResponse = this.http.post(this.baseUrl + '/getMeetingByMeetingId', data);
    return myResponse;
  }
}
